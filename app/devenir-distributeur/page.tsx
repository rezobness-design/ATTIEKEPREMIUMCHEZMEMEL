...
export default function DevenirDistributeurPage() {
  return (
    <PageShell title="Devenir Distributeur" description="Rejoignez le réseau Memel pour distribuer l’attiéké premium dans votre région.">
      <div className="grid gap-8 lg:grid-cols-[1fr_0.9fr]">
        <div className="rounded-[2rem] border border-memel-brown/10 bg-white/90 p-10 shadow-xl">
          <h2 className="text-2xl font-semibold">Pourquoi rejoindre Memel ?</h2>
        ...
        <div className="rounded-[2rem] bg-memel-brown p-10 text-white shadow-xl">
          ...
          <p className="mt-4 text-sm leading-7 text-white/80">Envoyez-nous un message via la page contact pour démarrer votre candidature.</p>
        </div>
      </div>
    </PageShell>
  );
